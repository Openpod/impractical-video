import { getKeyframeById } from "@opencut/animation";
import { getChannelEntriesFromData } from "@opencut/animation/channel-data";
import { isScalarChannel } from "@opencut/animation/interpolation";
import type { SelectedKeyframeRef } from "@opencut/animation/types";
import type { TimelineElement } from "@opencut/timeline";
import { PasteKeyframesCommand } from "@opencut/commands/timeline";
import type {
	ClipboardHandler,
	KeyframeClipboardCurvePatch,
	KeyframeClipboardItem,
} from "../types";
import { roundMediaTime, subMediaTime, type MediaTime } from "@opencut/wasm";
