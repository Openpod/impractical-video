...
import { clampRetimeRate, shouldMaintainPitch } from "@opencut/retime/rate";
import type { AudioClipSource } from "@opencut/media/audio";
import { createAudioContext, collectAudioClips } from "@opencut/media/audio";
import {
	buildAudioGainAutomation,
	hasAnimatedVolume,
} from "@opencut/timeline/audio-state";
import { createAudioMasteringChain } from "@opencut/media/audio-mastering";
import {
