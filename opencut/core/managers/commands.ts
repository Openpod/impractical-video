...
import type { Command, CommandResult } from "@opencut/commands";
import type { EditorSelectionSnapshot } from "@opencut/selection/editor-selection";
import { applyRippleAdjustments, computeRippleAdjustments } from "@opencut/ripple";
import type { SceneTracks } from "@opencut/timeline/types";
