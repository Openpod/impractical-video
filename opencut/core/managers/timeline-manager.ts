...
import type { ElementBounds } from "@opencut/preview/element-bounds";
...
import { TimelineDragSource } from "@opencut/timeline/drag-source";
import { findTrackInSceneTracks } from "@opencut/timeline/track-element-update";
import { lastFrameMediaTime, type MediaTime, ZERO_MEDIA_TIME } from "@opencut/wasm";
import {
	canElementBeHidden,
	canElementHaveAudio,
} from "@opencut/timeline/element-utils";
import { isElementMuted } from "@opencut/timeline/audio-state";
import type {
	AnimationPath,
	AnimationInterpolation,
	ScalarCurveKeyframePatch,
} from "@opencut/animation/types";
import type { ParamValue } from "@opencut/params";
import {
	getElementLocalTime,
	resolveAnimationPathValueAtTime,
} from "@opencut/animation";
import { resolveAnimationTarget } from "@opencut/timeline/animation-targets";
...
} from "@opencut/commands/timeline";
import type { InsertElementParams } from "@opencut/commands/timeline/element/insert-element";
import type {
	PlannedElementMove,
