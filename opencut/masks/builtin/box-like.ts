...
import type { NumberParamDefinition, ParamDefinition } from "@opencut/params";
import {
	getBoxMaskHandlePositions,
	getBoxMaskOverlays,
} from "@opencut/masks/handle-positions";
import { snapBoxMaskInteraction } from "@opencut/masks/snap";
