import type { ParamDefinition } from "@opencut/params";
import type {
	MaskDefinition,
	MaskParamUpdateArgs,
	TextMask,
...
import { MIN_FONT_SIZE, MAX_FONT_SIZE } from "@opencut/text/typography";
import {
	drawMeasuredTextLayout,
	measureTextLayout,
	strokeMeasuredTextLayout,
} from "@opencut/text/primitives";
import { getTextMeasurementContext } from "@opencut/text/measure-element";
import { getTextVisualRect } from "@opencut/text/layout";
import {
	getBoxMaskHandlePositions,
	getBoxMaskRectOverlay,
} from "@opencut/masks/handle-positions";
import { computeFeatherUpdate } from "@opencut/masks/param-update";
import {
	setMaskLocalCenter,
	toGlobalMaskSnapLines,
} from "@opencut/masks/geometry";
import {
	snapPosition,
	snapRotation,
	snapScale,
