...
import { shouldMaintainPitch } from "@opencut/retime/rate";
import type { MediaAsset } from "@opencut/media/types";
import { applyAudioMasteringToBuffer } from "@opencut/media/audio-mastering";
import type { AudioCapableElement } from "@opencut/timeline/audio-state";
import {
	hasAnimatedVolume,
	isElementMuted,
	resolveEffectiveAudioGain,
} from "@opencut/timeline/audio-state";
import { doesElementHaveEnabledAudio } from "@opencut/timeline/audio-separation";
import { canElementHaveAudio, hasMediaId } from "@opencut/timeline/element-utils";
import { canTrackHaveAudio } from "@opencut/timeline";
import { mediaSupportsAudio } from "@opencut/media/media-utils";
import { getSourceTimeAtClipTime, renderRetimedBuffer } from "@opencut/retime";
