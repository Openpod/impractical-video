...
import { STICKER_INTRINSIC_SIZE_FALLBACK } from "@opencut/stickers/intrinsic-size";
import { DEFAULT_GRAPHIC_SOURCE_SIZE } from "@opencut/graphics";
import { measureTextElement } from "@opencut/text/measure-element";
import {
	getElementLocalTime,
