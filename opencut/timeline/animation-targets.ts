...
} from "@opencut/animation/effect-param-channel";
import {
	parseGraphicParamPath,
} from "@opencut/animation/graphic-param-channel";
import { effectsRegistry, registerDefaultEffects } from "@opencut/effects";
import { getGraphicDefinition } from "@opencut/graphics";
import {
	coerceParamValue,
