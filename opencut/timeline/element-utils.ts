...
import type { MediaType } from "@opencut/media/types";
import { buildDefaultEffectInstance } from "@opencut/effects";
import { buildDefaultGraphicInstance } from "@opencut/graphics";
import type { ParamValues } from "@opencut/params";
import {
	buildDefaultParamValues,
	getBuiltInElementParams,
} from "@opencut/params/registry";
import { capitalizeFirstLetter } from "@opencut/utils/string";
